...
import type { SelectorEngine, SelectorRoot } from '.'
...
function validateSupportedOp(
  attr: AttributeSelectorPart,
  ops: AttributeSelectorOperator[]
) {
